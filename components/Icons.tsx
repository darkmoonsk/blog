  ...
  export const SunIcon = ({ className, ...rest }: any) => (
    ...
    >
      ...
      >
        ...
        <g dangerouslySetInnerHTML={{__html: '<set attributeName="opacity" begin="0.6s" to="0" />'}} />
      </g>
      ...
      <circle
        ...
        opacity="0"
      >
        <g dangerouslySetInnerHTML={{ __html: '<set attributeName="opacity" begin="0.6s" to="1" />'}} />
        <animate
          fill="freeze"
          attributeName="r"
          begin="0.6s"
    ...
    >
      ...
      >
        ...
        <path
          ...
          opacity="0"
        >
          <g dangerouslySetInnerHTML={{ __html: '<set attributeName="opacity" begin="0.5s" to="1" />'}} />
        </path>
      </g>
      ...
      >
        <g dangerouslySetInnerHTML={{ __html: '<set attributeName="opacity" begin="0.5s" to="0" />' }} />
        <animate
          fill="freeze"
          attributeName="r"
          begin="0.1s"
