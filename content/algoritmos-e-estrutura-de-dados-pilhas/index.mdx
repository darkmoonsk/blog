...
![Imagem mostrando as operações com a estrutura de dados pilha](./articles/algoritmos-e-estrutura-de-dados-pilhas/img1.png)
...
![Gif animado exemplificando a estrutura de dados pilha](./articles/algoritmos-e-estrutura-de-dados-pilhas/img2.gif)
