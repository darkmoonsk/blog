...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, jsFrameworksComparison__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, blogOne__indexMdx, masteringCssGridLayout__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webAccessibilityBestPractices__indexMdx, webDevelopmentToolsProductivity__indexMdx]
